...
describe User do
  ...
  describe "password validations" do
    ...
    it "should require a matching password confirmation" do
      mismatch_password_confirmation_user = 
        User.new(@attr.merge(:password_confirmation => "wrongpassword"))
      mismatch_password_confirmation_user.should_not be_valid
    end
    
    it "should reject passwords that are too short" do
      short = "a" * 5
      short_password_user = User.new(
        @attr.merge(:password => short, :password_confirmation => short))
    ...
    it "should reject passwords that are too long" do
      ...
      long_password_user = User.new(
        @attr.merge(:password => long, :password_confirmation => long))
